...
results = model.train(data="AI-Model/cfg/datasets/HP-PK-DS-12cls.yaml", 
...
# yolo export model=YoloV8s-PK-Tr8600-A1100B3000P4000O500.pt format=onnx imgsz=640 opset=12
